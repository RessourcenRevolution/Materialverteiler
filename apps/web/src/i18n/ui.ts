...
export const ui = {
  en: {
    ...
    'profile.management_settings': 'Manage',
    'profile.logout': 'Logout',
    'profile.your-listings.search': 'Search...',
    'profile.your-listings.status.all': 'All listings',
    'profile.your-listings.status.new': 'Pending listings',
    'profile.your-listings.status.open': 'Open listings',
    'profile.your-listings.status.reserved': 'Reserved listings',
    ...
    'profile.notifications.new-listing-digest': 'Receive a daily e-mail digest with all new listings',
    'profile.notifications.new-listing': 'Receive an e-mail for each new listing immediately',
  ...
  de: {
    ...
    'profile.management_settings': 'Management',
    'profile.your-listings.search': 'Suche...',
    'profile.your-listings.status.all': 'Alle Angebote',
    'profile.your-listings.status.new': 'Angebote in Prüfung',
    ...
    'profile.notifications.new-listing-digest': 'Tägliche Zusammenfassung aller neuen Materialangebote per E-Mail erhalten',
    'profile.notifications.new-listing': 'Sofort eine E-Mail bei jedem neuen Materialangebot erhalten',
